...
public class SAFIServiciosServiceLocator extends org.apache.axis.client.Service implements safisrv.ws.schemas.SAFIServiciosService {
    ...
    public safisrv.ws.schemas.SAFIServicios getSAFIServiciosSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public safisrv.ws.schemas.SAFIServicios getSAFIServiciosSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            safisrv.ws.schemas.SAFIServiciosSoap11Stub _stub = new safisrv.ws.schemas.SAFIServiciosSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (safisrv.ws.schemas.SAFIServicios.class.isAssignableFrom(serviceEndpointInterface)) {
                safisrv.ws.schemas.SAFIServiciosSoap11Stub _stub = new safisrv.ws.schemas.SAFIServiciosSoap11Stub(new java.net.URL(SAFIServiciosSoap11_address), this);
                _stub.setPortName(getSAFIServiciosSoap11WSDDServiceName());
                return _stub;
            }
        }
