 ...
 *         &lt;element name="montoGL" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "PagoCreditoRequest")
public class PagoCreditoRequest {
    ...
    /**
     * Gets the value of the montoGL property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the montoGL property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMontoGL(String value) {
        this.montoGL = value;
    }
