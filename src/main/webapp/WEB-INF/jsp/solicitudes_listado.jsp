...
<html>
	...
	<div class="">
        ...
        <h1 class="text-center color-amber">Solicitudes</h1>
        	<div class="row">
            	<div class="col-md-3">
                 <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- item-->
                        <c:forEach var="solicitudN" items="${listaSolicitudesNuevas}">
		                        <a href="solicitud?Folio=${solicitudN.idSolicitud}" class="btn btn-flat btn-primary list-custom">
		                            <div class="list-group-item">
		                                <div class="icon-clients">
		                                    <i class="mdi-action-assignment"></i>
		                                </div>
		                                <div class="row-content">
		                                    <p class="list-group-item-text">${solicitudN.cliente}</p>
		                                </div>
		                            </div>
		                         </a>
		                         <!-- item-->   
                     ...
                     <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Renovaciones</h3>
                    </div>
                    <div class="panel-body">
                        <div class="list-group">
                        <!-- item-->
                        <c:forEach var="solicitudR" items="${listaSolicitudesRenovadas}">
		                        <a href="#" class="btn btn-flat btn-primary list-custom">
		                            <div class="list-group-item">
		                                ...
		                                <div class="row-content">
		                                    <p class="list-group-item-text">${solicitudR.cliente}</p>
		                                </div>
		                            </div>
		                         </a>
		                         <!-- item-->   
