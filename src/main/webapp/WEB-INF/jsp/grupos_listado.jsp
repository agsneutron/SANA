...
<html>
	...
	<div class="">
        ...
        <h1 class="text-center color-amber">Grupos</h1>
        	<div class="row">
                 ...
                 <div class="panel panel-primary">
                        <div class="panel-heading">
                        	<div class="col-xs-6 col-sm-6 col-md-9">
                            	<h3 class="panel-title">Resumen de Grupos</h3>
                            </div>
                          ...
                          <table class="table table-bordered" id="tableSolicitudes">
                            ...
                            <c:forEach var="grupo" items="${listaGrupos}">
	                              <tr>
	                                ...
	                                <td>${grupo.idgrupo}</td>
	                                <td>${grupo.nombre}</td>
	                                <td>${grupo.fecha_registro}</td>
	                                <td>${grupo.idgruposafi}</td>
	                                <td><a href="grupos?Folio=${grupo.idgrupo}">Ver</a></td>
	                              </tr>
	                        </c:forEach>
